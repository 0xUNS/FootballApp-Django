...
function Club({ club }) {
    return (
        <Row className="align-items-center m-auto px-3 py-3">
            <Col>
            ...
            <Col align="center">
                    <Image src={club.country.flag} alt={club.country.name} width="48" height="48" roundedCircle/>
...
/*
        <div className="row" id="heading">
            <div id="heading-logo" style={{backgroundImage: `url(${club.logo})`}}></div>
            <div className="col" id="heading-title">
                ...
                <div>
                    ...
                    <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-fill" viewBox="0 0 16 16"><path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg> &nbsp;
                    coach: {club.coach.first_name} {club.coach.family_name} 
                    </div>
                </div>
            </div>
